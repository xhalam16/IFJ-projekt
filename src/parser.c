...
token_type_t checkForImmediateOperands(token_type_t tokenType, TreeNode *nodeExpression, Stack *stack)
{
    token_t token;
    ...
    *endMarkerPtr = NODE_EOL;
    ...
    do
    {
        ...
        */
        ...
        tokenType = checkForImmediateOperands(tokenType, nodeExpression, idTypeStack);
