...
\newcommand{\cunder}{\underline{\hspace{2.5mm}}}
...
\begin{titlepage}
	...
	\begin{table}[ht]
		...
		\begin{tabular}{|l|l|l|}
			...
			\textbf{Marek Halamka} & \begin{tabular}{l} Lexikální analýza, ADT Stack a ADT DynamicBuffer,\\ tabulky symbolů, sémantická analýza, dokumentace \end{tabular} & TBA\,\% \\ \hline
			Šimon Motl & \begin{tabular}{l} Syntaktická analýza, generování kódu, ADT DynamicArray, dokumentace \end{tabular} & TBA\,\% \\ \hline
			Richard Juřica & \begin{tabular}{l} Generování kódu \end{tabular} & TBA\,\% \\ \hline
			Jan Kroutil &  & 0\,\% \\ \hline
		\end{tabular}
...
\begin{table}[h]
	...
	\begin{enumerate}[noitemsep]
		...
		\item \texttt{<operator> $\rightarrow$ +}
		\item \texttt{<operator> $\rightarrow$ -}
		\item \texttt{<operator> $\rightarrow$ *}
		\item \texttt{<operator> $\rightarrow$ /}
		\item \texttt{<operator> $\rightarrow$ <}
		...
		\item \texttt{<param\_list1> $\rightarrow$ <param> , <param\_list1>}
		\item \texttt{<param\_list1> $\rightarrow$ )}
		\item \texttt{<param> $\rightarrow$ <value>}
		\item \texttt{<param> $\rightarrow$ identifier : <value>}
		\item \texttt{<func\_declaration> $\rightarrow$ func identifier ( <param\_list0> <return\_type> \{ <body> }
		...
		\item \texttt{<param\_list0>  $\rightarrow$ <label> <param> <param\_list0>}
...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{} & \textbf{epsilon} & \textbf{identifier} & \textbf{let} & \textbf{var} & \textbf{func} & \textbf{if} & \textbf{while} & \textbf{EOL} & \textbf{EOF} & \textbf{INT} & \textbf{DOUBLE} & \textbf{STRING} & \textbf{INT?} & \textbf{DOUBLE?} & \textbf{STRING?} & \textbf{int} & \textbf{double} & \textbf{string} & \textbf{nil} & \textbf{)} & \textbf{\cunder} & \textbf{\}} \\ \hline
        \textbf{\textless{}program\textgreater{}} & 1 & 1 & 1 & 1 & 1 & 1 & 1 & 2 & 3 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~  \\ \hline
        \textbf{\textless{}command\textgreater{}} & 4 & 5, 10 & 5, 6 & 5, 6 & 7 & 8 & 9 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~  \\ \hline
        \textbf{\textless{}assign\textgreater{}} & ~ & 11 & 11 & 11 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
        \textbf{\textless{}left\_value\textgreater{}} & ~ & 12 & 13, 14 & 13, 14 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
        \textbf{\textless{}right\_value\textgreater{}} & ~ & 16 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
        \textbf{\textless{}declaration\textgreater{}} & ~ & ~ & 17 & 17 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
        \textbf{\textless{}declaration\_keyword\textgreater{}} & ~ & ~ & 18 & 19 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
        \textbf{\textless{}datatype\textgreater{}} & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & 20 & 21 & 22 & 23 & 24 & 25 & ~ & ~ & ~ & ~ & ~ & ~ & ~  \\ \hline
